        ...
        if decision_card:
            ...
            try:
                ...
                await decisions_dao.create_decision(
                    ...
                    target_price=decision_card.get("target_price"),
                    entry_low=decision_card.get("entry_low"),
                    entry_high=decision_card.get("entry_high"),
                    stop_loss=decision_card.get("stop_loss"),
                    take_profit=decision_card.get("take_profit"),
